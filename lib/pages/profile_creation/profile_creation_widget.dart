              ...
              children: [
                      ...
                      Material(
                        ...
                        child: Container(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'PROFILE_CREATION_Stack_j36j5kca_ON_TAP');
                              logFirebaseEvent(
                              ...
                              if (selectedMedia != null &&
                                ...
                                safeSetState(() => _model
                                    .isDataUploading_uploadDataRn5 = true);
                                ...
                                try {
                                  ...
                                  _model.isDataUploading_uploadDataRn5 = false;
                                }
                                if (selectedUploadedFiles.length ==
                                    ...
                                    downloadUrls.length ==
                                        selectedMedia.length) {
                                  safeSetState(() {
                                    _model.uploadedLocalFile_uploadDataRn5 =
                                        selectedUploadedFiles.first;
                                    _model.uploadedFileUrl_uploadDataRn5 =
                                        downloadUrls.first;
                                  });
                                } else {
                                  safeSetState(() {});
                              ...
                              await currentUserReference!
                                ...
                                photoUrl: _model.uploadedFileUrl_uploadDataRn5,
                              ));
                            },
                            child: Stack(
                ...
                FFButtonWidget(
                  ...
                  onPressed: () async {
                    ...
                    logFirebaseEvent('CreateProfileButton_backend_call');
                    ...
                    logFirebaseEvent('CreateProfileButton_navigate_to');
