...
class _MessagesPageWidgetState extends State<MessagesPageWidget> {
  ...
  void initState() {
    ...
    _model.messagesTextFieldTextController ??= TextEditingController();
    _model.messagesTextFieldFocusNode ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<ChatsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final messagesPageChatsRecord = snapshot.data!;
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              title: StreamBuilder<UsersRecord>(
                stream: UsersRecord.getDocument(widget.otherUserRef!),
                builder: (context, snapshot) {
                  // Customize what your widget looks like when it's loading.
                  if (!snapshot.hasData) {
                    return Center(
                      ...
                      Column(
                        ...
                        children: [
                          FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'MESSAGES_PAGE_PAGE_Back_ON_TAP');
                    ...
                    child: StreamBuilder<List<ChatMessagesRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'MESSAGES_ListView_sykmogjo_ON_TAP');
                            ...
                            logFirebaseEvent('ListView_navigate_back');
                            context.safePop();
                          },
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, listViewIndex) {
                              ...
                              return Stack(
                                children: [
                                  if (listViewChatMessagesRecord.sentby ==
                                      currentUserReference)
                                    Padding(
                    ...
                    children: [
                      Expanded(
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller:
                                  _model.messagesTextFieldTextController,
                              focusNode: _model.messagesTextFieldFocusNode,
                      ...
                      Padding(
                        ...
                        child: FlutterFlowIconButton(
                          ...
                          disabledColor: Color(0xFF555A5A),
                          icon: Icon(
                            Icons.send_rounded,
                            color: FlutterFlowTheme.of(context).info,
                            size: 24.0,
                          ),
                          onPressed: (_model.messagesTextFieldTextController.text ==
                                      '')
                              ? null
                              : () async {
                                  logFirebaseEvent(
                                      'MESSAGES_send_rounded_ICN_ON_TAP');
                                  ...
                                  await ChatMessagesRecord.createDoc(
                                    ...
                                    message: _model
                                        .messagesTextFieldTextController.text,
                                  ...
                                  await messagesPageChatsRecord.reference
                                      .update({
                                  ...
                                  await ChatsRecord.collection
                                      ...
                                      .set(createChatsRecordData(
                                        lastMessage: _model
                                            .messagesTextFieldTextController
                                            .text,
                                      ));
                                  logFirebaseEvent('IconButton_backend_call');
