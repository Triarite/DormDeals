...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0073B6);
  late Color secondary = const Color(0xFF00598C);
  late Color tertiary = const Color(0xFFECE7E8);
  late Color alternate = const Color(0xFF131B23);
  late Color primaryText = const Color(0xFF131B23);
  late Color secondaryText = const Color(0xCC00598C);
  late Color primaryBackground = const Color(0xFFECE7E8);
